...
const CarVersionScrawler=async()=>{
    ...
    const browser = await puppeteer.launch({
        headless: false,  // Mở trình duyệt ở chế độ không ẩn (headless: true để ẩn)
        defaultViewport: { width: 1280, height: 720 }, // Kích thước cửa sổ trình duyệt
        args: ['--no-sandbox', '--disable-setuid-sandbox'] // Các tùy chọn để tăng hiệu suất hoặc tránh lỗi
    });
