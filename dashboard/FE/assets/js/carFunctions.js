            ...
            tableHTML += `
                <table>
                    ...
                    <tr>
                        ...
                        ${carVersions.map(version => `
                        <td>
                            <button onclick="confirmDelete('${version._id}')" style="border: none; background: none; cursor: pointer;">
                                <ion-icon name="trash-outline" style="color: red; font-size: 20px;"></ion-icon>
                            </button>
                        </td>      
                        `).join('')}
                    ...
                    <tr>
                        ...
                        ${carVersions.map(version => `
                        <td>
                            <button onclick="OpenFormEditCar('JSON.stringify(version).replace(/"/g, '&quot;')',event,'edit-form-car')" style="border: none; background: none; cursor: pointer;">
                                <ion-icon name="create-outline" style="color: blue; font-size: 20px;"></ion-icon>
                            </button>
                        </td>      
                        `).join('')}
